...
tags:
  ...
  - Databricksアシスタント
private: false
updated_at: '2026-03-02T15:24:18+09:00'
...
- [Databricksアシスタント概要](https://docs.databricks.com/ja/notebooks/databricks-assistant.html)
- [エージェントモード](https://docs.databricks.com/ja/notebooks/databricks-assistant-agent-mode.html)
- [データサイエンスエージェント](https://docs.databricks.com/ja/notebooks/databricks-assistant-agent-mode.html#data-science)
- [ダッシュボードオーサリングエージェント](https://docs.databricks.com/ja/dashboards/dashboard-assistant.html)
- [Agent Skills](https://docs.databricks.com/ja/notebooks/databricks-assistant-skills.html)
- [MCP（Model Context Protocol）](https://docs.databricks.com/ja/dev-tools/mcp.html)
